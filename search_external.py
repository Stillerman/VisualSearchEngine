...
ap.add_argument("-n", "--name", required=True, help="name of location")
...
for j in range(0, 10):
	...
	correct = args["name"] in imageName
	...
	# cv2.imshow("Result " + str(j + 1), result)
	# cv2.waitKey(0)
...
print ("Weighted Score: " + str(totalScore))
print (str(numRight) + " / " + str(numConsidered))
